...
from fragfold.src.colabfold_create_msa import (
    createIndividualMSAsFullLengthFragment,
    createIndividualMSAsFullLengthFragmentHeteromeric,
)
...
def main(args):
    ...
    if not args.protein_a3m_input or args.protein_a3m_input == args.fragment_a3m_input:
        ...
        msa_path_list = createIndividualMSAsFullLengthFragment(
            fragment_a3m,
            fragment_name,
            protein_range,
        ...
        msa_path_list = createIndividualMSAsFullLengthFragmentHeteromeric(
            fulllengthprotein_a3m_path,
